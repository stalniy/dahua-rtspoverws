...
function stringToUint8Array(a) {
    for (var b = a.length, c = new Uint8Array(new ArrayBuffer(b)), d = 0; b > d; d++)
        c[d] = a.charCodeAt(d);
    return c
}
function formAuthorizationResponse(a, b, c, d, e, f) {
    var g = null
      , h = null
      , i = null;
...
var isDebug = true
  ...
  , base64ArrayBuffer = function(a) {
    for (var b = "", c = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", d = new Uint8Array(a), e = d.byteLength, f = e % 3, g = e - f, h = 0, i = 0, j = 0, k = 0, l = 0, m = 0; g > m; m += 3)
