    ...
    function o(a, b) {
        ...
        if (a.bling < 20)
            ...
            c.ivsCanvasDraw.hideShape(a.shapeId, !1)),
            a.bling = 0,
    ...
    var s = function() {
      ...
      , t = {
        ...
        ivsModel: {
            ...
            CreateOneIntelShape: function(a, b, c, b, d, e, f) {
                var g = b;
                switch (b) {
                case "Spot":
                    g = "circle";
                ...
                return this.CreateMainVideoAnalyseShape(a, c, g, d, e, f)
            },
    ...
    var v = {
      ...
      , w = ["FocusZoomStatus"];
        export function CanvasDrawer(a) {
            a = a || {},
            this.channel = a.channel || 0,
            this.canvasDom = null,
            this.models = {},
            this.modelList = a.modelList || ["osdModel", "ivsModel", "previewModel", "motionModel"],
            this.curModel = null,
            this.curEvents = [],
            this.clickCallBack = a.clickCallBack,
            a && a.SDEV ? (this.SDEV = a.SDEV,
            this.sdevInit()) : this.init()
        }

import { CanvasDrawerPlugin } from './pluginCanvas'; 
        ...
        CanvasDrawer.prototype = {
            ...
            init: function() {
                ...
                document.body.appendChild(this.ivsCanvasDom),
                this.ivsCanvasDraw = new CanvasDrawerPlugin(),
                this.ivsCanvasDraw.init(this.ivsCanvasDom),
            ...
            receiveDataFromStream: function(a) {
                ...
                switch (b) {
                case 3:
                    s.publish("FocusZoomStatus", [c.Focus, c.Zoom, c.Status], this.channel)
                }
                if (!this.models.previewModel.enable)
                    return !1;
                switch (b) {
                case 0:
                    this.models.previewModel.drawRule(c);
                    break;
                case 1:
                    var d = {};
                    for (var e in c) {
                        if (20 !== c[e].type) {
                            this.models.previewModel.drawObject(c);
                            break
                        }
                        var f = c[e].appInfo
                          , g = this.models.previewModel.ivsOptions;
                        if (void 0 == g || "all" == g.appInfo) {
                            this.models.previewModel.drawSDEV(c);
                            break
                        }
                        20 == g.type && f == g.appInfo && (d[e] = c[e])
                    }
                    "{}" !== JSON.stringify(d) && this.models.previewModel.drawSDEV(d);
                    break;
                case 2:
                    this.models.previewModel.drawEvent(c);
                    break;
                case 4:
                    this.models.previewModel.drawFloorIdentification(c)
                }
            },
